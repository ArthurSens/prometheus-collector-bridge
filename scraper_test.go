...
// findMetric searches through all resource/scope/metric hierarchies to find a metric by name.
...
// collectMetricNames returns a map of metric name → metric type from the full metrics hierarchy.
